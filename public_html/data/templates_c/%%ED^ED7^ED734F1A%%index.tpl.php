...
<h1 id="logo"><a style="behavior: url(#default#homepage)" title="把<?php echo @SITE_DOMAIN; ?>
网址导航 设为主页" onclick="this.style.behavior='url(#default#homepage)';this.sethomepage('http://<?php echo @SITE_DOMAIN; ?>
