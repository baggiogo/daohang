...
/i/index.php?a=reg">注册i首页</a>&nbsp;&nbsp;|&nbsp;&nbsp;<a href="http://<?php echo @SITE_DOMAIN; ?>
">首页</a></div>
  <div class="r01"></div>
</div>
 <div id="logo" style=" width:990px"><a href="http://www.5w.com" target="_blank"><img src="../static/images/logo.gif" title="5w导航"/></a></div>


 <div id="login"><div class="m_reg">
  <div class="title">
   <span class="tab">用户登录</span><div class="more" style="color:#666666">我还未注册，现在去 <a href="http://<?php echo @SITE_DOMAIN; ?>
...
/i/?c=login&act=login" method="post">
   <ul class="reg" style="margin:45px;">
    <li><span>用户名：</span><input class="input" name="tbUserName" type="text" value="<?php echo $this->_tpl_vars['userName']; ?>
" id="tbUserName"/></li>
    ...
    <li><span>&nbsp;</span><input class="set_btn"  type="submit" name="loginsubmit" value="登 录" /><a href="http://<?php echo @SITE_DOMAIN; ?>
/i/?a=getpwd" style="color:#06c">忘记密码？</a>
...
/i/?c=manage" /></li>
 ...
 <div class="reg_des">
  <div class="title">
   <span class="tab">什么是5w个性导航？</span> </div>
  <div class="main">
  <ul>
   <li>
