...
<link href="http://<?{$smarty.const.SITE_DOMAIN}?>/theme/<?{$smarty.const.THEME_PATH}?>css/base.css" rel="stylesheet" type="text/css" />
<link href="http://<?{$smarty.const.SITE_DOMAIN}?>/theme/<?{$smarty.const.THEME_PATH}?>css/global.css" rel="stylesheet" type="text/css" />
...
<div id="header_detail">
  <div id="logo"><a href="/"><img src="<?{$smarty.const.SITE_LOGO}?>" /></a></div>
  <div id="search_s">
...
<div id="main_detail">
  <dl>
   ...
   <form id="add" method="post" onsubmit="return checkSite();" action="http://<?{$smarty.const.SITE_DOMAIN}?>/apply.php?a=add">
     ...
     <li><span>Alexa排名：</span><input name="alexaRank" id="alexaRank" type="text" class="s" /><label>全球网站排名&nbsp;&nbsp;<a href="http://www.aosoo.com/" target="_blank">查询Alexa排名</a></label>
     </li>
