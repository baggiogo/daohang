...
var str1=str2=str3='';
    if(undefined!=json.cityName)
    	var str = '<table border=0 cellSpacing=0 cellPadding=0 width="100%" height="50px"><TBODY><TR><TH class=city height=40><a title="查看天气详情" href="http://tianqi.5w.com" target=_blank nowrap="true">'+json.cityName+'</a></TH><TD rowSpan=2><a href="http://tianqi.5w.com" target=_blank nowrap="true">';
    else
    	var str = '';
