...
<link href="http://<?{$smarty.const.SITE_DOMAIN}?>/theme/<?{$smarty.const.THEME_PATH}?>css/style_default.css" rel="stylesheet" type="text/css" id="links"/>
...
<div id="sform_detail">
<form name="f" action="<?{$defaultsearch.action}?>" method="get">
...
<td<?{if $smarty.foreach.list1.index < 5}?> width="20%"<?{/if}?>><a style="<?{if $dirsites.siteColor!=''}?>color:<?{$dirsites.sitecolor}?><?{/if}?>" href="<?{$dirsites.siteUrl}?>"><?{$dirsites.siteName}?></a></td>
...
<td<?{if $smarty.foreach.list.index < 5}?> width="20%"<?{/if}?>><a <?{if $tempsite.siteColor!=''}?>style="color:<?{$tempsite.siteColor}?>"<?{/if}?> href="<?{$tempsite.siteUrl}?>"><?{$tempsite.siteName}?></a></td>
...
<td<?{if $smarty.foreach.list2.index < 5}?> width="20%"<?{/if}?>><a style="" href="<?{$dir.stpHtmlName}?>"><?{$dir.stpName}?></a></td>
