...
<td<?{if $smarty.foreach.list1.index < 5}?> width="20%"<?{/if}?>><a style="" href="<?{$dirsites.siteUrl}?>"><?{$dirsites.siteName}?></a></td>
...
<td<?{if $smarty.foreach.list.index < 5}?> width="20%"<?{/if}?>><a style="" href="<?{$tempsite.siteUrl}?>"><?{$tempsite.siteName}?></a></td>
