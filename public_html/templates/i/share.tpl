...
<body class="bg">
  <div id="warp">
    <div id="top">
      <div class="logo"><a href="http://www.5w.com" target="_blank"><img src="http://www.5w.com/static/images/logo.gif" /></a></div>
      <div class="add">
      <?{if $uname==''}?>
      <span>加入5w一起分享潮流 <a href="javascript:;" onclick="showform();">登录</a></span>&nbsp;|&nbsp;<span><a href="http://<?{$smarty.const.SITE_DOMAIN}?>/i/share.php?a=sreg&url=<?{$url}?>&title=<?{$title}?>" target="_self">注册</a></span>
      <?{else}?>
