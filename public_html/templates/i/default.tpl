...
<title><?{$title|default:"5w!个性导航站 -- 自定义导航,网络收藏夹,个性门户"}?></title>
...
<div class="clear"></div>
 <div id="tool">
  <div class="title">
   <span class="tab">实用工具</span> <span class="more"><a href="http://chaxun.5w.com">更多>></a></span>  </div>
  <div class="main">
    <ul style="width:auto">
