  ...
  <tr>
    ...
    <table id="datatable" width="100%" border="0" cellspacing="0" cellpadding="0" class="table_list" title="双击编辑">
      ...
      <tr id="display_row_<?{$voLists[loop].tid}?>" ondblclick="submitLineEdit(<?{$voLists[loop].tid}?>)">
        ...
        <td class="tr_a"><a href="javascript:;" onclick="submitLineEdit(<?{$voLists[loop].tid}?>)"><img src="images/ico_edit.gif" title="编辑" /></a>
      ...
      <tr id="edit_row_<?{$voLists[loop].tid}?>" style="display:none">
       ...
       <?{/section}?>
       <tr>
         <td height="30" colspan="3" align="right" valign="middle" class="ly_Rtd" style="cursor:pointer"><?{$pager}?><input type="button" class="button" value="新增" onclick="addNewSite()"/>&nbsp;<input type="button" class="button" value=" 全编辑 " onclick="showAllEditStatus()">&nbsp;<input type="button" class="button" value=" 全提交 " onclick="submitAllEdit()">&nbsp;</td>
       </tr>
     </table>
