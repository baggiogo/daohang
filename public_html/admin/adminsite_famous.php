...
$p = isset($_GET['p'])?(int)$_GET['p']:1;
	...
	$ct = 'SELECT count(*) as ct FROM '.DBPREFIX.'site_famous WHERE 1=1';
	$sql = 'SELECT siteSort,siteID,siteName,siteUrl,siteStatus,siteColor FROM '.DBPREFIX.'site_famous WHERE 1=1';
...
$objS -> display("admin/adminsite_famous.tpl");
?>
