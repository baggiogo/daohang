...
function toolChange(c){
	var u=new Array('http://www.5w.com/data/html/youxi.htm','http://www.5w.com/data/html/jipiao.htm','http://www.5w.com/data/html/jiudian.htm');
	var b=4;
	for(var a=1;a<=b;a++){
...
bcache[13]='<form method="get" action="http://www.google.com.hk/cse" name="f"><p><a href="http://www.google.com.hk/webhp?prog=aff&amp;client=pub-9491289701756083&amp;channel=3192690012"><img border="0" src="http://www.5w.com/static/images/s/google.gif"></a><input type="text" id="b_kw" name="q" autocomplete="off" class="int" size="42"><input type="hidden" value="partner-pub-9491289701756083:sxy07z809dy" name="cx"><input type="hidden" value="GB2312" name="ie"><input type="submit" class="btn" id="bdbutton" value="谷歌搜索"></p></form>';
...
bcache[44]='<form method="get" action="http://www.youdao.com/search" name="f"><p><a href="http://www.youdao.com/n2/?keyfrom=dh.5w_0001&amp;vendor=dh.5w_0001"><img border="0" src="http://www.5w.com/static/images/s/youdao.gif"></a><input type="text" id="b_kw" name="q" autocomplete="off" class="int" size="42"><input type="hidden" value="gbk" name="ue"><input type="hidden" value="dh.5w_0001" name="keyfrom"><input type="hidden" value="dh.5w_0001" name="vendor"><input type="submit" class="btn" id="bdbutton" value="搜 索"></p></form>';
bcache[45]='<form method="get" action="http://movie.gougou.com/search" name="f"><p><a href="http://movie.gougou.com/search"><img border="0" src="http://www.5w.com/static/images/s/gougou.gif"></a><input type="text" id="b_kw" name="search" autocomplete="off" class="int" size="42"><input type="hidden" value="10000000" name="id"><input type="submit" class="btn" id="bdbutton" value="搜 索"></p></form>';
